...
private String[] arraystringfordirectory(ApfsDirectory Elementforfs) {
	...
	public void verifyDirectoryEqualityApplications() { 
		...
		String[] expected = { "true", "applications", "0", localTime.toString(), "root", "1050", "2", "Krishna", localTime.toString() };
	...
	public void verifyDirectoryEqualityCode() { 
		APFS FilesystemofApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory)FilesystemofApfs.getRootDir();
		String[] expected = { "true", "code", "0", localTime.toString(), "home", "1570", "2", "Krishna", localTime.toString() };
	...
	public void verifyDirectoryEqualityRoot() {
		APFS FilesystemofApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory)FilesystemofApfs.getRootDir();
		String[] expected = { "true", "root", "0", LocalDateTime.of(2019, 12, 20, 0, 0).toString(), null, "3500", "2", "Krishna", LocalDateTime.of(2019, 12, 20, 0, 0).toString() };
	...
	public void verifyDirectoryEqualityHome() { 
		APFS FilesystemofApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory)FilesystemofApfs.getRootDir();
		String[] expected = { "true", "home", "0", localTime.toString(), "root", "2450", "3", "Krishna", localTime.toString() };
