...
public class ApfsDirectory extends ApfsElement{
	...
	public ApfsDirectory(ApfsDirectory parent, String name, int size, LocalDateTime Time, String ownerName, LocalDateTime lastModified) {
	...
	public ApfsLink findLinkByName(String nlink) {
		ApfsLink link = null;
		for(ApfsLink l : getLinks()) {
			if(nlink.equals(l.getName()))
				link = l;
		}
		if(link == null) {
			for(ApfsDirectory dir : getSubDirectories()) {
				link = dir.findLinkByName(nlink);
				if(link != null)
					break;
			}
		}
	...
	public static void main(String[] args) {
		System.out.println("The class ApfsDirectory has run successfully");
	}
}
