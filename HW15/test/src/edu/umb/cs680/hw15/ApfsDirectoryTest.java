...
static LocalDateTime PresentTime = LocalDateTime.of(2020, 05, 12, 0, 0);
private String[] arraystringfordirectory(ApfsDirectory directory) {
	...
	public void verifyDirectoryEqualityHome() { 
		APFS FilesystemofApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory)FilesystemofApfs.getRootDir();
		String[] expected = { "true", "home", "0", PresentTime.toString(), "root", "2450", "3", "Krishna", PresentTime.toString() };
	...
	public void verifyDirectoryEqualityCode() { 
		APFS FilesystemofApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory)FilesystemofApfs.getRootDir();
		String[] expected = { "true", "code", "0", PresentTime.toString(), "home", "1570", "2", "Krishna", PresentTime.toString() };
	...
	public void verifyDirectoryEqualityApplications() { 
		APFS ApfsFileSystem = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory)ApfsFileSystem.getRootDir();
		String[] expected = { "true", "applications", "0", PresentTime.toString(), "root", "1050", "2", "Krishna", PresentTime.toString() };
	...
	public void verifyDirectoryEqualityRoot() {
		APFS FilesystemofApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory)FilesystemofApfs.getRootDir();
		String[] expected = { "true", "root", "0", PresentTime.toString(), null, "3500", "2", "Krishna", PresentTime.toString() };
