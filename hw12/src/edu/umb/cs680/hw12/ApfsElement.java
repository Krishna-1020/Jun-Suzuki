...
public class ApfsElement extends FSElement {
	...
	public ApfsElement(ApfsElement parent, String name, int size, LocalDateTime creationTime, String owner, LocalDateTime lastModDate) {
	...
	public static void main(String[] args) {
		System.out.println("ApfsElement successful");
	}
}