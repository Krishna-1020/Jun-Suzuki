...
public class AlphabeticalComparatorTest {
	...
	private void before() {
		...
		ApfsElement picture = new ApfsDirectory(home, "Picture", 0, LocalDateTime.of(2019, 3, 2, 11, 0), "author",
				null);
	...
	public void verifyLinkEqualitySystem() {
		...
		LinkedList<ApfsElement> l2 = ((ApfsDirectory) filesys.getRoot()).getChildren(new AlphabeticalComparator());
